          ...
          <div class="wrap">
            <header>
              ...
              <div style="display:flex; flex-wrap:wrap; gap:0.6rem; margin-top:0.9rem;">
                ...
                <a href="../../webpage/cee223-earthquake-protective-systems.html" style="text-decoration:none; border:1px solid var(--border); padding:0.45rem 0.7rem; border-radius:999px; color:var(--ucb-blue); background:#ffffff;">
